...
func (k *KafkaLogEmitter) Trace(message interface{}, params ...interface{}) {
	k.Emit(newLogLine(k.config.Source, TraceLogTypeId, fmt.Sprintf(fmt.Sprint(message), params), k.config.Tags))
}
...
func (k *KafkaLogEmitter) Debug(message interface{}, params ...interface{}) {
	k.Emit(newLogLine(k.config.Source, DebugLogTypeId, fmt.Sprintf(fmt.Sprint(message), params), k.config.Tags))
}
...
func (k *KafkaLogEmitter) Info(message interface{}, params ...interface{}) {
	k.Emit(newLogLine(k.config.Source, InfoLogTypeId, fmt.Sprintf(fmt.Sprint(message), params), k.config.Tags))
}
...
func (k *KafkaLogEmitter) Warn(message interface{}, params ...interface{}) {
	k.Emit(newLogLine(k.config.Source, WarnLogTypeId, fmt.Sprintf(fmt.Sprint(message), params), k.config.Tags))
}
...
func (k *KafkaLogEmitter) Error(message interface{}, params ...interface{}) {
	k.Emit(newLogLine(k.config.Source, ErrorLogTypeId, fmt.Sprintf(fmt.Sprint(message), params), k.config.Tags))
}
...
func (k *KafkaLogEmitter) Critical(message interface{}, params ...interface{}) {
	k.Emit(newLogLine(k.config.Source, CriticalLogTypeId, fmt.Sprintf(fmt.Sprint(message), params), k.config.Tags))
}

func (k *KafkaLogEmitter) Write(bytes []byte) (int, error) {
	k.Emit(newLogLine(k.config.Source, 0, string(bytes), k.config.Tags))
