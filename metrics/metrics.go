...
import (
	...
	avroline "github.com/elodina/pyrgus/avro"
...
func NewKafkaWriter(topic string, producerConfig *siesta.ProducerConfig, connectorConfig *siesta.ConnectorConfig) (*KafkaWriter, error) {
	connector, err := siesta.NewDefaultConnector(connectorConfig)
	if err != nil {
		return nil, err
	}
